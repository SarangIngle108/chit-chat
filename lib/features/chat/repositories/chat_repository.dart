...
class ChatRepository {
  ...
  Stream<List<Message>> getChatStream(String recieverUserId) {
    return firestore
      ...
      for (var docuent in event.docs) {
        messages.add(
          Message.fromMap(docuent.data()),
        );
      }
      return messages;
    });
  ...
  void _saveDataToContactsSubCollection(
    ...
    // user -> recieverid => chats->currenuserid->setdata
  ...
  void _saveMessageToMessageSubCollection({
    ...
    required String recieversUserName,
  ...
  //  required MessageEnum repliedMessageType,
    ...
    final message = Message(
      ...
      repliedTo: messageReply == null ? '' : messageReply.isMe ? senderUserName : recieversUserName,
    //  repliedMessageType: repliedMessageType,
    );
    //users->senderid->recieverid->massages->messageid->storemessage
    await firestore
        .collection('users')
        .doc(auth.currentUser!.uid)
        .collection('chats')
    ...
    //users->recieverid->senderid->massages->messageid->storemessage
  ...
  void sendTextMessage({
    ...
    try {
      ...
      _saveMessageToMessageSubCollection(
        ...
        recieversUserName: recieverUserData.name,
  ...
  void sendFileMessage({
   ...
   String imageUrl = await ref.read(CommonFirebaseStorageRepositoryProvider)
        .storeFileToFirebase('chat/${messageEnum.type}/${senderUserData.uid}/$recieverUserId/$messageId', file);
    ...
    _saveMessageToMessageSubCollection(
      ...
      showSnackBar(context: context, content: "Failed to Upload");
    }
